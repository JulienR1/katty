...
export class RemoveCommand extends Command {
  ...
  private successEmbed = (songTitle: string) => new SuccessEmbed().setTitle(i18n.__("remove.title", { song: songTitle }));

  private errorEmbed = (songNumber: number) => new ErrorEmbed().setDescription(i18n.__("remove.error", { songNumber: songNumber.toString() }));
}
