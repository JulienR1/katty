...
export type NoTrackResult = { type: "no-track" }
export type SingleTrackResult = { type: "single-track"; track: Track }
export type PlaylistResult = { type: "playlist"; tracks: Track[]; playlistInfo: TrackInfo }
